...
export default function Lefthome ()  {
 return (
    <Box boxShadow='dark-lg' backgroundColor='#FFFFFF' borderRadius="10px" width={400} height={440} marginTop={100} marginLeft={7} textAlign="center" textColor="black" justifyItems="center" fontWeight='bolder' paddingTop="50px" paddingLeft="10px" paddingBottom="20px"> 
